...
<header class="flex-md-nowrap border-bottom d-flex container-fluid m-0 row">
    <div class="align-items-center mb-3 mb-md-0 me-md-auto flex-column d-flex col-2 m-0">
        <span class="h2 text-dark text-center">在庫管理一覧</span>
    </div>
    ...
    <div class="align-items-center mb-3 mb-md-0 me-md-auto flex-column d-flex col-2 m-0">
        <span class="h2 text-dark text-center">在庫</span>
    </div>
    <div class="align-items-center mb-3 mb-md-0 me-md-auto flex-column d-flex col-4 m-0">
        ...
        <!-- <div class=" align-items-center mb-3 mb-md-0 me-md-auto flex-column col-2 ">
            <span class="h2 text-dark">在庫管理一覧</span>
        </div>
        <div class="align-items-center mb-3 mb-md-0 me-md-auto  flex-column col-3">
            <span class="h2 text-dark">名前</span>
        </div>
        <div class="align-items-center mb-3 mb-md-0 me-md-auto flex-column col-2">
            <span class="h2 text-dark">在庫</span>
        </div>
        <div class="align-items-center mb-3 mb-md-0 me-md-auto flex-column col-4 ">
            <span class="h2 text-dark ">期限</span>
        </div> -->
